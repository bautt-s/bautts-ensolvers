	...
	return (
		<div className="w-screen h-screen flex justify-center items-center bg-[#14213D]">
			<div className="flex flex-col">
				<h1 className="text-center text-4xl sm:text-5xl text-[#FFFFFF] font-bold">Welcome to Notely!</h1>
				<h3 className="text-center text-lg sm:text-2xl mt-[15px] text-[#FFFFFF]">An app to keep track of your most important thoughts.</h3>
